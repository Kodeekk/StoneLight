...
function navbar_buttons_activation() {
    ...
    navbarbuttons.forEach((element)=>{
        if (!element.classList.contains("active")) console.log("Ready! now, element '" + element.innerText + "' does`nt have 'active' class!");
    });
...
console.log(document.URL.toString()) // switch (document.URL.toString) {
...
},{}]},["hSiTh","5AKj5"], "5AKj5", "parcelRequire3a62")
